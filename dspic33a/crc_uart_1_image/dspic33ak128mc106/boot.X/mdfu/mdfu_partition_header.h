...
#define MDFU_PARTITION_HEADER_VERSION_NUMBER_LENGTH     (4UL)
#define MDFU_PARTITION_HEADER_DATA_SIZE_LENGTH          (4UL)
#define MDFU_PARTITION_HEADER_DATA_SIZE_LENGTH          (4UL)
#define MDFU_PARTITION_HEADER_END_OF_HEADER_LENGTH      (0UL)
