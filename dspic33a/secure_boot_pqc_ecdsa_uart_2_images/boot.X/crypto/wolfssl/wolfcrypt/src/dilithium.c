...
#if (defined(__OPTIMIZE__)) && (__XC_DSC_VERSION__ == 3030)
#warning "Known issue: dilithium.c is not compatible with optimization in XC-DSC v3.30. Please compile dilithium.c with -O0 or upgrade the compiler."
#endif
