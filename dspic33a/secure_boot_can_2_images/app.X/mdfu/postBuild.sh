...
export cyan="[46m"
export red="[41m"
export private_key_path="../../boot.X/mdfu/keystore/p384_private_key.pem"
...
hexmate r80E000-0x846FFF,"$projectDir/$imageDir/$imageName" -O"$projectDir/$imageDir/filled.hex" -FILL=w1:0x00@0x80E000:0x846FFF || Error

# generate a .hex file for just the header (offset to address 0)
hexmate r80E060-0x80E1FFs-80E060,"$projectDir/$imageDir/filled.hex" -O"$projectDir/$imageDir/header.hex" || Error
...
hexmate r80E200-0x846FFFs-80E200,"$projectDir/$imageDir/filled.hex" -O"$projectDir/$imageDir/data.hex" || Error
...
# generate a .hex file for just the header (offset to address 0)
hexmate r80E000-0x846FFFs-80E000,"$projectDir/$imageDir/filled.hex" -O"$projectDir/$imageDir/presigned_image.hex" || Error
