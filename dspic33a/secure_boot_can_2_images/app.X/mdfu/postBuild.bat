...
hexmate r80E000-0x846FFF,"%projectDir%\%imageDir%\%imageName%" -O"%projectDir%\%imageDir%\filled.hex" -FILL=w1:0x00@0x80E000:0x846FFF || goto Error

REM generate a .hex file for just the header (offset to address 0)
hexmate r80E060-0x80E1FFs-80E060,"%projectDir%\%imageDir%\filled.hex" -O"%projectDir%\%imageDir%\header.hex" || goto Error
...
hexmate r80E200-0x846FFFs-80E200,"%projectDir%\%imageDir%\filled.hex" -O"%projectDir%\%imageDir%\data.hex" || goto Error
...
REM generate a .hex file for presigned for the entire image
hexmate r80E000-0x846FFFs-80E000,"%projectDir%\%imageDir%\filled.hex" -O"%projectDir%\%imageDir%\presigned_image.hex" || goto Error

REM Generate the binary file of the image
