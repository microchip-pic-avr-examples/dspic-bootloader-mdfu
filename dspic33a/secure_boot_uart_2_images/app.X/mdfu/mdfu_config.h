...
#define MDFU_CONFIG_HEADER_INTEGRITY_LENGTH (48UL)
#define MDFU_CONFIG_HEADER_SIGNATURE_LENGTH (96ul)
 ...
 * linker file.
 ******************************************************************************/
#define MDFU_CONFIG_KEYSTORE_DATA_ORIGIN      (0x80B000ul)
 ...
 * linker file.
 ******************************************************************************/
#define MDFU_CONFIG_EXECUTABLE_ORIGIN           (0x80C000ul)
#define MDFU_CONFIG_EXECUTABLE_LENGTH           (0x03A000ul)
 ...
 * linker file.
 ******************************************************************************/
#define MDFU_CONFIG_DOWNLOAD_ORIGIN           (0x846000ul)
#define MDFU_CONFIG_DOWNLOAD_LENGTH           (0x03A000ul)

#define MDFU_CONFIG_DOWNLOAD_SIGNATURE_ORIGIN (MDFU_CONFIG_DOWNLOAD_ORIGIN)
#define MDFU_CONFIG_DOWNLOAD_SIGNATURE_LENGTH (MDFU_CONFIG_HEADER_OFFSET)

#define MDFU_CONFIG_DOWNLOAD_HEADER_ORIGIN    (MDFU_CONFIG_DOWNLOAD_SIGNATURE_ORIGIN + MDFU_CONFIG_DOWNLOAD_SIGNATURE_LENGTH)
#define MDFU_CONFIG_DOWNLOAD_HEADER_LENGTH    (MDFU_CONFIG_HEADER_LENGTH)

#define MDFU_CONFIG_DOWNLOAD_DATA_ORIGIN      (MDFU_CONFIG_DOWNLOAD_HEADER_ORIGIN + MDFU_CONFIG_DOWNLOAD_HEADER_LENGTH)
#define MDFU_CONFIG_DOWNLOAD_DATA_LENGTH      (MDFU_CONFIG_DOWNLOAD_LENGTH - MDFU_CONFIG_DOWNLOAD_SIGNATURE_LENGTH - MDFU_CONFIG_DOWNLOAD_HEADER_LENGTH)
