...
#ifndef KEYSTORE_MEMORY_READ
#define KEYSTORE_MEMORY_READ(destination, source, length) (void)memcpy(destination, source, length)
#endif
...
{    
    ...
    */
    ...
    {
        KEYSTORE_MEMORY_READ(buffer, &publicKeyStart[offset], actualLength);
    }
