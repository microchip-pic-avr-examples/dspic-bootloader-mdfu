...
enum MDFU_PARTITION_STATUS
{
    ...
    MDFU_PARTITION_STATUS_MODE_UNSUPPORTED = 1,
    MDFU_PARTITION_STATUS_LOCKED = 2,
    MDFU_PARTITION_STATUS_INVALID_ARGUMENT = 3,
    MDFU_PARTITION_STATUS_OPERATION_FAILED = 4
};

enum MDFU_PARTITION_HASH_ALGORITHM
{
    MDFU_PARTITION_HASH_ALGORITHM_SHA2_384,
    MDFU_PARTITION_HASH_ALGORITHM_SHA2_512
};
