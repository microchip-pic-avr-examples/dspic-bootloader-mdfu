...
REM ------------------------------------
REM Argument(6): DFP_DIR
REM 
REM Description:
REM   Path to the DFP (Device Family Pack) directory
REM ------------------------------------
Set DFP_DIR=%~6
if exist "%DFP_DIR%\xc16" (
    Set DFP_DIR=%DFP_DIR%\xc16
)
...
echo .....................................
call python pre_sign_tool.py --config postBuildConfig.json --compilerDir %OBJ_CPY% --projectDir %projectDir% --imageDir %imageDir% --imageName %imageName% --dfp %DFP_DIR% || goto Error
